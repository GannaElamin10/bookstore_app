  ...
  Widget build(BuildContext context) {
     return Scaffold(
      bottomNavigationBar: CurvedNavigationBar(index: currentIndex,
       ...
       items: [
  Icon(Icons.home, size: 30, color: currentIndex == 0 ? Colors.pink : Colors.grey),
  Icon(Icons.book_outlined, size: 30, color: currentIndex == 1 ? Colors.pink : Colors.grey),
  Icon(Icons.search, size: 30, color: currentIndex == 2 ? Colors.pink : Colors.grey),
  Icon(Icons.shopping_cart, size: 30, color: currentIndex == 3 ? Colors.pink : Colors.grey),
  Icon(Icons.people, size: 30, color: currentIndex == 4 ? Colors.pink : Colors.grey),
],
