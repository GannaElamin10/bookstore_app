...
class SearchScreen extends StatelessWidget {
                          ...
                          return Column(
                            children: [
                              for (var book in state.searchResults)
                                Row(
                                  children: [
                                    _buildBookCard(book), // Pass book to build card
                                    SizedBox(width: 10),
                                  ],
                                ),
                            ],
  ...
  // Update the _buildBookCard to accept a dynamic book object
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                book['price'], // Use price from book object
                style: TextStyle(
                  fontWeight: FontWeight.bold,
              ...
              SizedBox(width: 6),
              Text(
                book['priceAfterDiscount'], // Use discounted price from book object
                style: TextStyle(
                  fontSize: 12,
